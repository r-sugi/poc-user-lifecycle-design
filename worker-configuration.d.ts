/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 0ae6728f93b5f692f047ddb1f80246f7)
// Runtime types generated with workerd@1.20260801.1 2025-08-03 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	SESSIONS_KV: KVNamespace;
	DB: D1Database;
	SESSION_REVOCATIONS: Queue;
	APP_BASE_URL: string;
	APP_ENV: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_BASE_URL" | "APP_ENV" | "ADMIN_BOOTSTRAP_EMAIL" | "ADMIN_BOOTSTRAP_PASSWORD" | "SEED_USER_PASSWORD" | "SEED_ADMIN_PASSWORD" | "INTERNAL_BATCH_SECRET">> {}
}
